    ...
    public static class NekoTailTrinketRenderer implements TrinketRenderer {
        ...
        public void render(ItemStack item, SlotReference slotReference, EntityModel<? extends LivingEntity> model, PoseStack poseStack, MultiBufferSource vertexConsumers, int light, LivingEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
            try {
                ...
                // 执行渲染
                renderer.renderToBuffer(poseStack, vertexConsumers.getBuffer(RenderType.entityTranslucent(BuiltInRegistries.ITEM.getKey(NEKO_TAIL))), light, OverlayTexture.NO_OVERLAY, 1, 1, 1, 1);
    ...
    public static class NekoEarsTrinketRenderer implements TrinketRenderer {
        ...
        public void render(ItemStack item, SlotReference slotReference, EntityModel<? extends LivingEntity> model, PoseStack poseStack, MultiBufferSource vertexConsumers, int light, LivingEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
            try {
                ...
                // 执行渲染
                renderer.renderToBuffer(poseStack, vertexConsumers.getBuffer(RenderType.entityTranslucent(BuiltInRegistries.ITEM.getKey(NEKO_EARS))), light, OverlayTexture.NO_OVERLAY, 1, 1, 1, 1);
    ...
    public static class NekoPawsTrinketRenderer implements TrinketRenderer {
        ...
        public void render(ItemStack item, SlotReference slotReference, EntityModel<? extends LivingEntity> model, PoseStack poseStack, MultiBufferSource vertexConsumers, int light, LivingEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
            ...
            try {
                ...
                // 执行渲染
                renderer.renderToBuffer(poseStack, vertexConsumers.getBuffer(RenderType.entityTranslucent(BuiltInRegistries.ITEM.getKey(NEKO_PAWS))), light, OverlayTexture.NO_OVERLAY, 1, 1, 1, 1);
